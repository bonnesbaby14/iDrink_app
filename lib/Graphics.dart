...
class _GraphicsState extends State<Graphics> {
  ...
  Future<void> fetchImages() async {
    final List<String> urls = [
      'https://idrink-api-prod-idrink-api-fqemyp.mo2.mogenius.io/graphics_status', // URL de la primera imagen
      'https://idrink-api-prod-idrink-api-fqemyp.mo2.mogenius.io/graphics_orders', // URL de la segunda imagen
